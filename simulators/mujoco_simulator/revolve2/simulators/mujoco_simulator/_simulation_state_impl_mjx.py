...
class SimulationStateImplMJX(SimulationState):
    ...
    def __init__(self, data: mjx.Data, abstraction_to_mujoco_mapping: AbstractionToMujocoMapping) -> None:
        """
        ...
        """
        self._xpos = np.array(data.xpos)
        self._xquat = np.array(data.xquat)
        self._qpos = np.array(data.qpos)
