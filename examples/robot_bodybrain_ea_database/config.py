...
NUM_REPETITIONS = 2#5
NUM_SIMULATORS = 8
POPULATION_SIZE = 20#100#100
OFFSPRING_SIZE = 10 # 50#50
NUM_RANDOM_SEARCH = 10
NUM_GENERATIONS = 30#100
NPARENTS = 2
...
# Assertions
if ALGORITHM == "GRN":
    assert MUTATION_PROBABILITY == 0.1, "MUTATION_PROBABILITY must be 0.1 if ALGORITHM is GRN"
    assert CROSSOVER_PROBABILITY == 0, "CROSSOVER_PROBABILITY must be 0 if ALGORITHM is GRN"
elif ALGORITHM == "CPPN":
    assert MUTATION_PROBABILITY == 0.1, "MUTATION_PROBABILITY must be 0.1 if ALGORITHM is CPPN"
    assert CROSSOVER_PROBABILITY == 1, "CROSSOVER_PROBABILITY must be 1 if ALGORITHM is CPPN"
else:
